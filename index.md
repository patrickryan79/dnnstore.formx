...
## New in v1.7.0: Added compatibility with DNN 10, and better support for custom actions!!!
- `ChangePasswordQuestionAnswer` form action
- `ChangePasswordWithAnswer` form action
- `SendPassword` form action
- `VerifyQuestionAnswer` form action
- `SendSystemMail` form action
